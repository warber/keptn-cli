...
// GetProjectResource provides a mock function with given fields: project, resourceURI, options
func (_m *ResourcesV1Interface) GetProjectResource(project string, resourceURI string, options ...api.GetOption) (*models.Resource, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, project, resourceURI)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	var r0 *models.Resource
	if rf, ok := ret.Get(0).(func(string, string, ...api.GetOption) *models.Resource); ok {
		r0 = rf(project, resourceURI, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Resource)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, string, ...api.GetOption) error); ok {
		r1 = rf(project, resourceURI, options...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *ResourcesV1Interface_Expecter) GetProjectResource(project interface{}, resourceURI interface{}, options ...interface{}) *ResourcesV1Interface_GetProjectResource_Call {
	return &ResourcesV1Interface_GetProjectResource_Call{Call: _e.mock.On("GetProjectResource",
		append([]interface{}{project, resourceURI}, options...)...)}
}

func (_c *ResourcesV1Interface_GetProjectResource_Call) Run(run func(project string, resourceURI string, options ...api.GetOption)) *ResourcesV1Interface_GetProjectResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]api.GetOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
				variadicArgs[i] = a.(api.GetOption)
			}
		}
...
// GetServiceResource provides a mock function with given fields: project, stage, service, resourceURI, options
func (_m *ResourcesV1Interface) GetServiceResource(project string, stage string, service string, resourceURI string, options ...api.GetOption) (*models.Resource, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, project, stage, service, resourceURI)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	var r0 *models.Resource
	if rf, ok := ret.Get(0).(func(string, string, string, string, ...api.GetOption) *models.Resource); ok {
		r0 = rf(project, stage, service, resourceURI, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Resource)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, string, string, string, ...api.GetOption) error); ok {
		r1 = rf(project, stage, service, resourceURI, options...)
	} else {
		r1 = ret.Error(1)
	}
...
//  - resourceURI string
//  - options ...api.GetOption
func (_e *ResourcesV1Interface_Expecter) GetServiceResource(project interface{}, stage interface{}, service interface{}, resourceURI interface{}, options ...interface{}) *ResourcesV1Interface_GetServiceResource_Call {
	return &ResourcesV1Interface_GetServiceResource_Call{Call: _e.mock.On("GetServiceResource",
		append([]interface{}{project, stage, service, resourceURI}, options...)...)}
}

func (_c *ResourcesV1Interface_GetServiceResource_Call) Run(run func(project string, stage string, service string, resourceURI string, options ...api.GetOption)) *ResourcesV1Interface_GetServiceResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]api.GetOption, len(args)-4)
...
// GetStageResource provides a mock function with given fields: project, stage, resourceURI, options
func (_m *ResourcesV1Interface) GetStageResource(project string, stage string, resourceURI string, options ...api.GetOption) (*models.Resource, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, project, stage, resourceURI)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	var r0 *models.Resource
	if rf, ok := ret.Get(0).(func(string, string, string, ...api.GetOption) *models.Resource); ok {
		r0 = rf(project, stage, resourceURI, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Resource)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, string, string, ...api.GetOption) error); ok {
		r1 = rf(project, stage, resourceURI, options...)
	} else {
		r1 = ret.Error(1)
	}
...
//  - resourceURI string
//  - options ...api.GetOption
func (_e *ResourcesV1Interface_Expecter) GetStageResource(project interface{}, stage interface{}, resourceURI interface{}, options ...interface{}) *ResourcesV1Interface_GetStageResource_Call {
	return &ResourcesV1Interface_GetStageResource_Call{Call: _e.mock.On("GetStageResource",
		append([]interface{}{project, stage, resourceURI}, options...)...)}
}

func (_c *ResourcesV1Interface_GetStageResource_Call) Run(run func(project string, stage string, resourceURI string, options ...api.GetOption)) *ResourcesV1Interface_GetStageResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]api.GetOption, len(args)-3)
